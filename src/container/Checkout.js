                                ...
                                <form action="#" method="post">
                                    <div className="row">
                                        ...
                                        <div className="col-12 mb-3">
                                            ...
                                            <input type="text" className="form-control mb-3" id="street_address" defaultValue />
                                            <input type="text" className="form-control" id="street_address2" defaultValue />
                                        </div>
                                        <div className="col-12 mb-3">
                                            <label htmlFor="postcode">Postcode <span>*</span></label>
                                            <input type="text" className="form-control" id="postcode" defaultValue />
                                        </div>
                                        <div className="col-12 mb-3">
                                            <label htmlFor="city">Town/City <span>*</span></label>
                                            <input type="text" className="form-control" id="city" defaultValue />
                                        </div>
                                        <div className="col-12 mb-3">
                                            <label htmlFor="state">Province <span>*</span></label>
                                            <input type="text" className="form-control" id="state" defaultValue />
                                        </div>
                                        <div className="col-12 mb-3">
                                            <label htmlFor="phone_number">Phone No <span>*</span></label>
                                            <input type="number" className="form-control" id="phone_number" min={0} defaultValue />
                                        </div>
                                        <div className="col-12 mb-4">
                                            <label htmlFor="email_address">Email Address <span>*</span></label>
                                            <input type="email" className="form-control" id="email_address" defaultValue />
                                        </div>
                                    ...
                                    {data.map((v,i)=>{
                                        return(
                                            <ul className="order-details-form mb-4">
                                                ...
                                                <li><span>{v.name}</span> <span>{v.price}</span></li>
                                                <li><span>Subtotal</span> <span>{v.price}</span></li>
                                                <li><span>Shipping</span> <span>Free</span></li>
                                                <li><span>Total</span> <span>{v.price}</span></li>
                                             </ul>
                                        )
                                    })}
